...
document.addEventListener('keydown', function(event) {
    if (event.key === 'ArrowRight') {
        window.location.href = '/automation';  // Replace '/nextpage.html' with the actual next page
    }
    if (event.key === 'ArrowLeft') {
        window.location.href = '/witness';  // Replace '/previouspage.html' with the actual previous page
    }
});
